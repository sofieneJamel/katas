package org.katas.fizzbuzz.implTwo;
...
public class FizzBuzzImplTwoTest {
    ...
    public void should_return_Fizz_when_number_is_dividble_by_3() throws Exception {
        ...
        // When
        String numberToDisplay = fizzBuzz.displayNumberImplTwo(number);
    ...
    @Test
    public void should_throw_Exception_when_number_is_negative() throws Exception {
        // Given
        ...
        // When
        fizzBuzz.displayNumberImplTwo(number);
